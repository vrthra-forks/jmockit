...
public @interface Mock
{
    ...
    * Existing mock methods marked as reentrant should instead have an {@link Invocation} parameter.
    * Uses of the "<code>it</code>" field should be replaced with calls to corresponding methods in the
    * {@code Invocation} object, in particular {@link Invocation#getInvokedInstance()} to obtain the "it" instance, and
    * {@link Invocation#proceed(...)} to execute the real method.
    */
   @Deprecated
