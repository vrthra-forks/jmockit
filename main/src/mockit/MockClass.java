 ...
 * Existing mock classes should extend the {@linkplain MockUp MockUp&lt;T>} base class instead of using the annotation.
 * In cases where the {@link #stubs} attribute is specified, the methods/constructors to be stubbed out should instead
 * have corresponding {@code @Mock} methods with empty bodies.
 */
@Deprecated
