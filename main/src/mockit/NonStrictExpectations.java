...
/**
 * An {@link Expectations} subclass where all expectations are automatically {@linkplain NonStrict non-strict}.
 * <pre>
 *
...
public abstract class NonStrictExpectations extends Expectations
{
    ...
    * recorded will be {@linkplain NonStrict non-strict} by default.
    *
    ...
    * expectations recorded will be {@linkplain NonStrict non-strict} by default.
    * <p/>
    ...
    * that all expectations recorded will be {@linkplain NonStrict non-strict} by default.
    * <p/>
