...
public final class ExpectationsWithValuesToReturnTest
{
   ...
   @Test(expected = IllegalArgumentException.class)
   public void returnsMockedCollectionForSimpleReturnType(@Mocked final Collaborator mock)
   {
      new NonStrictExpectations() {
         @Mocked List<String> values;
   ...
   @Test
   public void createAppropriateContainerFromSingleRecordedValueOfTheElementType(final Collaborator mock)
   {
      final Double d = 1.2;
      final Float f = 3.45F;
   ...
   @Test
   public void createArrayFromSingleRecordedValueOfTheElementType(final Collaborator mock)
   {
      new NonStrictExpectations() {{
