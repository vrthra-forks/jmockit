...
public final class KeyValuesTest
{
   ...
   @Test
   public void getValueForToAnimationWithLowerIndexDifferentThanUpperIndex(final Evaluator<Float> evaluator)
   {
   ...
   @Test
   public void getValueForNotToAnimationWithLowerIndexDifferentThanUpperIndex(final Evaluator<Float> evaluator)
   {
