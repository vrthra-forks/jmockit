...
{
   public boolean replaceData(String dataId, byte[] binaryData)
   {
    ...
    * @param binaryData The binary data that will be stored. If <code>null</code> this means that the
    *                   data for the particular slot is considered removed.
