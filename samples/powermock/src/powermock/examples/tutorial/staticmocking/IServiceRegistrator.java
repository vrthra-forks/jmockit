 ...
 */
package powermock.examples.tutorial.staticmocking;
...
public interface IServiceRegistrator
{
    ...
    *
    * @param name                  The name of the service the register.
    ...
    *
    * @param id The id of the service that should be removed. The id was
    *           generated by {@link #registerService(String, Object)}.
    * @throws IllegalStateException If this <code>ServiceRegistration</code> object has already
    *                               been unregistered.
    */
