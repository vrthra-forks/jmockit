 ...
 */
package powermock.examples.tutorial.domainmocking;
...
public interface EventService
{
    ...
    *
    * @param person   The person to object associated with this event.
    * @param messages The business messages object that may contain errors or
    *                 warnings.
    */
