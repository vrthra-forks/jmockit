...
/**
 * This is a simple example of a factory class that provides dependencies that are shared by many
 * classes (dependency lookup pattern). This approach is quite common when dependency injection is
 * not used.
 */
